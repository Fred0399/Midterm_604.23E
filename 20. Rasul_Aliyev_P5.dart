...
//   // instead of giving length of ourList manually,
//   // you should use ourList.length method, to make everything work dynamically
//   // For example: for(int i = 0; i < ourList.length; i++)
//   for(int i = 0; i < 6; i++)
//   {
//     print(squaredList[i]);
//   }
...
void checkPalin(String word){
  // NOTE: you should change everything to lower, or upper case before checking;
  bool isPalin = true;
